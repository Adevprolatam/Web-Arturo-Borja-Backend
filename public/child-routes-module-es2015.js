...
/* harmony import */ var _grafica1_grafica1_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./grafica1/grafica1.component */ "./src/app/pages/grafica1/grafica1.component.ts");
/* harmony import */ var _account_settings_account_settings_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./account-settings/account-settings.component */ "./src/app/pages/account-settings/account-settings.component.ts");
/* harmony import */ var _promesas_promesas_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./promesas/promesas.component */ "./src/app/pages/promesas/promesas.component.ts");
...
/* harmony import */ var _mantenimientos_usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./mantenimientos/usuarios/usuarios.component */ "./src/app/pages/mantenimientos/usuarios/usuarios.component.ts");
/* harmony import */ var _mantenimientos_hospitales_hospitales_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./mantenimientos/hospitales/hospitales.component */ "./src/app/pages/mantenimientos/hospitales/hospitales.component.ts");
/* harmony import */ var _mantenimientos_medicos_medicos_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./mantenimientos/medicos/medicos.component */ "./src/app/pages/mantenimientos/medicos/medicos.component.ts");
/* harmony import */ var _mantenimientos_medicos_medico_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./mantenimientos/medicos/medico.component */ "./src/app/pages/mantenimientos/medicos/medico.component.ts");
/* harmony import */ var _busqueda_busqueda_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./busqueda/busqueda.component */ "./src/app/pages/busqueda/busqueda.component.ts");
/* harmony import */ var _guards_admin_guard__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../guards/admin.guard */ "./src/app/guards/admin.guard.ts");
/* harmony import */ var _dise_o_fotos_fotos_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./diseño/fotos/fotos.component */ "./src/app/pages/diseño/fotos/fotos.component.ts");
/* harmony import */ var _dise_o_fotos_foto_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./diseño/fotos/foto.component */ "./src/app/pages/diseño/fotos/foto.component.ts");
/* harmony import */ var _dise_o_blog_blog_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./diseño/blog/blog.component */ "./src/app/pages/diseño/blog/blog.component.ts");
/* harmony import */ var _dise_o_blog_blogs_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./diseño/blog/blogs.component */ "./src/app/pages/diseño/blog/blogs.component.ts");
/* harmony import */ var _dise_o_noticias_noticias_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./diseño/noticias/noticias.component */ "./src/app/pages/diseño/noticias/noticias.component.ts");
/* harmony import */ var _dise_o_noticias_noticia_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./diseño/noticias/noticia.component */ "./src/app/pages/diseño/noticias/noticia.component.ts");
/* harmony import */ var _helpme_api_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./helpme/api.component */ "./src/app/pages/helpme/api.component.ts");
/* harmony import */ var _helpme_information_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./helpme/information.component */ "./src/app/pages/helpme/information.component.ts");
/* harmony import */ var _helpme_certification_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./helpme/certification.component */ "./src/app/pages/helpme/certification.component.ts");
/* harmony import */ var _dise_o_cronogrma_cronogrma_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./diseño/cronogrma/cronogrma.component */ "./src/app/pages/diseño/cronogrma/cronogrma.component.ts");
/* harmony import */ var _helpme_developer_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./helpme/developer.component */ "./src/app/pages/helpme/developer.component.ts");
/* harmony import */ var _perfil_myperfil_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./perfil/myperfil.component */ "./src/app/pages/perfil/myperfil.component.ts");
/* harmony import */ var _mantenimientos_institucion_institucion_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./mantenimientos/institucion/institucion.component */ "./src/app/pages/mantenimientos/institucion/institucion.component.ts");
/* harmony import */ var _dise_o_questions_questions_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./diseño/questions/questions.component */ "./src/app/pages/diseño/questions/questions.component.ts");
/* harmony import */ var _dise_o_questions_question_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./diseño/questions/question.component */ "./src/app/pages/diseño/questions/question.component.ts");
...
const childRoutes = [
    ...
    { path: 'account-settings', component: _account_settings_account_settings_component__WEBPACK_IMPORTED_MODULE_5__["AccountSettingsComponent"], data: { titulo: 'Ajustes de cuenta' } },
    { path: 'buscar/:termino', component: _busqueda_busqueda_component__WEBPACK_IMPORTED_MODULE_13__["BusquedaComponent"], data: { titulo: 'Busquedas' } },
    { path: 'grafica1', component: _grafica1_grafica1_component__WEBPACK_IMPORTED_MODULE_4__["Grafica1Component"], data: { titulo: 'Gráfica #1' } },
    { path: 'perfil', component: _perfil_perfil_component__WEBPACK_IMPORTED_MODULE_8__["PerfilComponent"], data: { titulo: 'Actualizar usuario' } },
    { path: 'myperfil', component: _perfil_myperfil_component__WEBPACK_IMPORTED_MODULE_26__["MyPerfilComponent"], data: { titulo: 'Perfil de usuario' } },
    { path: 'progress', component: _progress_progress_component__WEBPACK_IMPORTED_MODULE_3__["ProgressComponent"], data: { titulo: 'ProgressBar' } },
    { path: 'promesas', component: _promesas_promesas_component__WEBPACK_IMPORTED_MODULE_6__["PromesasComponent"], data: { titulo: 'Promesas' } },
    { path: 'rxjs', component: _rxjs_rxjs_component__WEBPACK_IMPORTED_MODULE_7__["RxjsComponent"], data: { titulo: 'RxJs' } },
    // Mantenimientos
    { path: 'hospitales', component: _mantenimientos_hospitales_hospitales_component__WEBPACK_IMPORTED_MODULE_10__["HospitalesComponent"], data: { titulo: 'Categorias' } },
    { path: 'medicos', component: _mantenimientos_medicos_medicos_component__WEBPACK_IMPORTED_MODULE_11__["MedicosComponent"], data: { titulo: 'Personal Institucional' } },
    { path: 'school', component: _mantenimientos_institucion_institucion_component__WEBPACK_IMPORTED_MODULE_27__["InstitucionComponent"], data: { titulo: 'Configuración de Institución' } },
    { path: 'medico/:id', component: _mantenimientos_medicos_medico_component__WEBPACK_IMPORTED_MODULE_12__["MedicoComponent"], data: { titulo: 'Usuario' } },
    // Diseño
    { path: 'photos', component: _dise_o_fotos_fotos_component__WEBPACK_IMPORTED_MODULE_15__["FotosComponent"], data: { titulo: 'Fotos' } },
    { path: 'photo/:id', component: _dise_o_fotos_foto_component__WEBPACK_IMPORTED_MODULE_16__["FotoComponent"], data: { titulo: 'Fotos' } },
    { path: 'blog', component: _dise_o_blog_blog_component__WEBPACK_IMPORTED_MODULE_17__["BlogComponent"], data: { titulo: 'blogs' } },
    { path: 'blogs/:id', component: _dise_o_blog_blogs_component__WEBPACK_IMPORTED_MODULE_18__["BlogsComponent"], data: { titulo: 'blog' } },
    { path: 'news', component: _dise_o_noticias_noticias_component__WEBPACK_IMPORTED_MODULE_19__["NoticiasComponent"], data: { titulo: 'Noticias' } },
    { path: 'news/:id', component: _dise_o_noticias_noticia_component__WEBPACK_IMPORTED_MODULE_20__["NoticiaComponent"], data: { titulo: 'Noticia' } },
    { path: 'questions', component: _dise_o_questions_questions_component__WEBPACK_IMPORTED_MODULE_28__["QuestionsComponent"], data: { titulo: 'Preguntas Frecuentes' } },
    { path: 'question/:id', component: _dise_o_questions_question_component__WEBPACK_IMPORTED_MODULE_29__["QuestionComponent"], data: { titulo: 'Pregunta' } },
    { path: 'cronograma', component: _dise_o_cronogrma_cronogrma_component__WEBPACK_IMPORTED_MODULE_24__["CronogrmaComponent"], data: { titulo: 'Cronograma' } },
    //HELPME
    { path: 'api', component: _helpme_api_component__WEBPACK_IMPORTED_MODULE_21__["ApiComponent"], data: { titulo: 'API REST' } },
    { path: 'information', component: _helpme_information_component__WEBPACK_IMPORTED_MODULE_22__["InformationComponent"], data: { titulo: 'Información' } },
    { path: 'certification', component: _helpme_certification_component__WEBPACK_IMPORTED_MODULE_23__["CertificationComponent"], data: { titulo: 'Certificados' } },
    { path: 'developer', component: _helpme_developer_component__WEBPACK_IMPORTED_MODULE_25__["DeveloperComponent"], data: { titulo: 'Desarrolladores' } },
    // Rutas de Admin
    { path: 'usuarios', canActivate: [_guards_admin_guard__WEBPACK_IMPORTED_MODULE_14__["AdminGuard"]], component: _mantenimientos_usuarios_usuarios_component__WEBPACK_IMPORTED_MODULE_9__["UsuariosComponent"], data: { titulo: 'Matenimiento de Usuarios' } },
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyPerfilComponent", function() { return MyPerfilComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _services_usuario_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/usuario.service */ "./src/app/services/usuario.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MyPerfilComponent, [{
