...
const API_KEY= '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';
...
app.post('/cambiarPassword', (req, res) => {
    ...
    if (usuarioDB) {
        ...
        var token = jwt.sign({ to }, process.env.JWT_SECRET, { expiresIn: 1800 }); //30 min
       ...
       const message ={
        ...
        to: `${body.to}`,
        subject: 'Recuperacion de cuenta ༼ つ ◕_◕ ༽つ',
        html: `
           ...
           <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
             <tr> 
              <td align="center" valign="top" style="padding:0;Margin:0;width:560px"> 
               <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                 <tr> 
                  <td align="center" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#212121">Recuperar tu contraseña</h1></td> 
                 </tr> 
                 <tr> 
                  <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;font-size:16px"><span style="font-weight: 600; ">Hemos recibido una petición para cambiar tu contraseña , solo haz click en el boton para redireccionarte a la pagina de restablecimiento de contraseña</td> 
                 </tr> 
               </table></td> 
             </tr> 
           </table></td> 
             ...
             <tr> 
              <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
               <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                 ...
                 <tr> 
                  <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#FFFFFF;font-size:10x">¿No has sido tu? No te preocupes ignora este mensaje</p></td> 
                 </tr> 
                 <tr>
                    <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><a href="http://localhost:4200/reset/${token}" class="btn" target="_blank" style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#FFFFFF;font-size:10x">Recuperar Contraseña</a></td> 
                 </tr>
               </table></td> 
             </tr> 
           </table></td> 
