...
<body>
  <div class="container d-flex justify-content-center p-3 ">
    <div class="alert alert-info" role="alert">
        Mensaje Enviado Correctamente :3
    </div>
</body>
</html>
...
router.post("/api/send-email", (req, res)=>{
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="center" valign="top" style="padding:0;Margin:0;width:560px"> 
                       <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                         <tr> 
                          <td align="center" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#212121">Mensaje enviado desde la pagina<br>Arturo Borja!</h1></td> 
                         </tr> 
                         <tr> 
                          <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;font-size:16px"><span style="font-weight: 600; ">Remitente: </span>${email}</p><br><span style="font-weight: 600; ">Nombre del remitente: </span>${name}</td> 
                         </tr> 
                       </table></td> 
                     </tr> 
                   </table></td> 
                     ...
                     <tr> 
                      <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                       <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                         ...
                         <tr> 
                          <td align="left" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#FFFFFF;text-align:center">Mensaje</h1></td> 
                         </tr> 
                         <tr> 
                          <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#FFFFFF;font-size:16px">${message}</p></td> 
                         </tr> 
                       </table></td> 
                     </tr> 
                   </table></td> 
    ...
    const CLIENT_ID="838201980564-ab30v38pmqcdcenhlomcejueo0ll3ndh.apps.googleusercontent.com"
    const CLIENT_SECRET="tC2vdSJkCs98rgRwMMfuNLTG"
    const REDIRECT_URI="https://developers.google.com/oauthplayground/"
    const REFRESH_TOKEN="1//048y6PFhNSiPGCgYIARAAGAQSNwF-L9IrME7yBdL8qOshlo83qPjvR1GWw3F5tVBfG5aE300OPn2ze29_iuI0EyxhSwATIexRpfw"
...
async function sendMail(){
    try{
        ...
        const mailOptions ={
            from:"Unidad Educativa Arturo Borja <adevprolatam@gmail>",
            to:"uefarturoborja@gmail.com",
            subject:"Mensaje enviado desde caja de comentarios",
            html: contentHTML,
        };
  ...
  sendMail()
  .then((result)=>res.send(succefull))
